...
def certificados_skills():
    ...
    st.markdown("""
                ...
                - 🧠 **Inteligência Artificial e IA Generativa:**
                   * 📥 **RAG (Retrieval-Augmented Generation)** Implementação da técnica RAG para integrar 
                        bases internas de conhecimento a modelos de IA como ChatOpenAI, 
                        permitindo que os assistentes virtuais acessem informações específicas e forneçam 
                        respostas mais personalizadas e assertivas.
